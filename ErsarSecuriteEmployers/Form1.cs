...
using ErsarSecuriteEmployers.Data;
using System;
    ...
    public partial class Form1 : Form
    {
        ...
        void FirstClick()
        {
            ...
            if (CurrentBtnClicked == null)
            {
                ...
                NouvButton.ForeColor = FirstColor;
                CurrentBtnClicked = NouvButton;
            }
            else
            {
                CurrentBtnClicked.BackColor = FirstColor;
                CurrentBtnClicked.ForeColor = SecColor;
                NouvButton.BackColor = SecColor;
                NouvButton.ForeColor = FirstColor;
                CurrentBtnClicked = NouvButton;
            }
