...
namespace ErsarSecuriteEmployers.Data
{
        ...
        private void CreateFiche()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ws.Shapes.AddPicture(photo, Microsoft.Office.Core.MsoTriState.msoFalse,
                        Microsoft.Office.Core.MsoTriState.msoCTrue, leftPosition, topPosition, width, height);
                }
